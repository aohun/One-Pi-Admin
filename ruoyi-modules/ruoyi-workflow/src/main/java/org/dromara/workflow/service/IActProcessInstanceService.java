...
public interface IActProcessInstanceService {
    ...
    TableDataInfo<ProcessInstanceVo> getPageForHi(ProcessInstanceBo processInstanceBo, PageQuery pageQuery);
    /**
     * 分页查询已结束的流程实例
     *
     * @param processInstanceBo 参数
     ...
     * @return
     */
    boolean suspendOrActivateProcessInstanceById(String processInstanceId);
