...
public class ActProcessInstanceController extends BaseController {
    ...
    @RepeatSubmit()
    @PostMapping("/saProcessInstanceById/{processInstanceId}")
    public R<Void> saProcessInstanceById(@PathVariable String processInstanceId) {
        return toAjax(actProcessInstanceService.suspendOrActivateProcessInstanceById(processInstanceId));
    }
